...
private fun formatTrackDuration(durationMs: Long): String {
    ...
    return String.format(java.util.Locale.US, "%d:%02d", durationSec / 60, durationSec % 60)
}
                ...
                Row(
                    ...
                    Button(
                        onClick = {
                            ...
                            Toast.makeText(context, "Copied all info", Toast.LENGTH_SHORT).show()
                        },
                    ...
                    Button(
                        onClick = {
                            ...
                            context.startActivity(Intent.createChooser(intent, "Share Info"))
                        },
                        colors = ButtonDefaults.buttonColors(containerColor = AppColors.bg3),
                        modifier = Modifier.weight(1f)
                    ) {
