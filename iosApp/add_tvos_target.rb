...
%w[TvOSApp TvContainer TvRootView TvConnectView TvLibraryView TvObservables TvAlbumTracksView TvZonesView TvArtwork TvSearchView TvNowPlayingDetailView].each do |name|
